...
* Внедрена поддержка аннотации `@AggregateReference` для Spring Data JDBC (ASPR-1653)
...
* Внесена возможность добавления внешнего ключа при генерации Liquibase скрипта для Spring Data JDBC проекта (ASPR-1729)
