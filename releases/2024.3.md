...
* Добавлена возможность добавления внешнего ключа при генерации Liquibase скрипта в Spring Data JDBC проекте (ASPR-1729)
* Добавлена поддержка keyColumn при генерации Liquibase скрипта в Spring Data JDBC проекте (ASPR-1730)
* Добавлена поддержка References для полей с FK в окне Entity from DB для Spring Data JDBC проекта (ASPR-1764)
* Добавлена возможность создания файла через @Sql аннотацию (ASPR-1711)
...
* Исправлена проблема с отсутствием @RequestMapping-метода на панели Amplicode Explorer в списке эндпоинтов (ASPR-1845)
