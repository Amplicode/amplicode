...
* Добавлена генерация ConneKt-скриптов через Scratches (ASPR-2073) + 
...
* Исправлено значение `@Param` при создании метода с `Collection` (ASPR-2002)
* Исправлено отсутствие маппинга при создании CRUD REST-контроллера (ASPR-2003)
* Исправлена генерация Converter, Formatter и Argument Resolver классов (ASPR-2193)
...
## Улучшения производительности и стабильность

* Повышена производительность автодополнения в классах (ASPR-2208)
* Устранена ошибка "Module is already disposed" при расчёте PersistenceUnits (ASPR-2163)

## Ошибки и сбои

* Устранён конфликт ID действия `ThrowTestExceptionAction` (ASPR-2245)
